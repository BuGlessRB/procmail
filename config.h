/*$Id: config.h,v 1.15 1993/01/27 20:32:55 berg Exp $*/
...
Post(ma(st(er)?|n)|office)|Mailer|daemon|mmdf|root|uucp|LISTSERV|owner|request|
bounce|serv(ices?|er))([^.a-z]|$))"    /* should match most kinds of daemons */
